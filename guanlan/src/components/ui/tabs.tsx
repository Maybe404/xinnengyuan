  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-white data-[state=active]:text-foreground data-[state=active]:shadow-[0_1px_3px_oklch(0.4_0.03_260/0.18),inset_0_1px_0_oklch(1_0_0/0.8)] dark:data-[state=active]:bg-white/15 dark:data-[state=active]:shadow-none",
